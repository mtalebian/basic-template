...
namespace Common.Cryptography
{
    ...
    public static class RSAClass
    {
        ...
        {
            var rsa = new RSACryptoServiceProvider();
            rsa.FromXmlString(_publicKey.ToUnsecureString());
