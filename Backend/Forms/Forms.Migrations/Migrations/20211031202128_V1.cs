        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseInVariant = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                schema: "tmp",
                table: "Grids",
                columns: new[] { "Id", "ProjectId", "CreatedAt", "CreatedBy", "DeleteSql", "Description", "GroupId", "InsertSql", "ModifiedAt", "ModifiedBy", "SelectSql", "TableName", "Title", "UpdateSql" },
                values: new object[,]
                {
                    { "tmp.Projects", "project1", new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(8173), "", null, null, 1, null, new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(8173), "", null, "tmp.Projects", "Projects", null },
                    { "tmp.AzObjects", "project1", new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9784), "", null, null, 1, null, new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9784), "", null, "tmp.AzObjects", "AzObjects", null },
                    { "tmp.AzObjectFields", "project1", new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9788), "", null, null, 1, null, new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9788), "", null, "tmp.AzObjectFields", "AzObjectFields", null },
                    { "tmp.AzFields", "project1", new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9792), "", null, null, 1, null, new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9792), "", null, "tmp.AzFields", "AzFields", null },
                    { "tmp.Applications", "project1", new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9792), "", null, null, 1, null, new DateTime(2021, 10, 31, 20, 21, 28, 203, DateTimeKind.Utc).AddTicks(9792), "", null, "tmp.Applications", "Applications", null }
                });
