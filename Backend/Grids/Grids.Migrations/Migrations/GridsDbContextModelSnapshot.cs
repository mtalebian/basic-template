...
{
    [DbContext(typeof(GridsDbContext))]
    partial class GridsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forms.Core.Grid", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProjectId = "project1",
                            Id = "tmp.Projects",
                            CreatedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(2989),
                            CreatedBy = "",
                            Filterable = true,
                            FlexLayout = false,
                            GroupId = 1,
                            HasFilterVariant = false,
                            ModifiedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(2989),
                            ModifiedBy = "",
                        ...
                        new
                        {
                            ProjectId = "project1",
                            Id = "tmp.AzObjects",
                            CreatedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4668),
                            CreatedBy = "",
                            Filterable = true,
                            FlexLayout = false,
                            GroupId = 1,
                            HasFilterVariant = false,
                            ModifiedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4668),
                            ModifiedBy = "",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676),
                            CreatedBy = "",
                            Filterable = true,
                            FlexLayout = false,
                            GroupId = 1,
                            HasFilterVariant = false,
                            ModifiedAt = new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676),
                            ModifiedBy = "",
            ...
            modelBuilder.Entity("Forms.Core.GridGroup", b =>
                {
                    b.Property<string>("ProjectId")
                        .HasMaxLength(20)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("Forms.Core.Grid", b =>
                {
                    b.HasOne("Forms.Core.GridGroup", "Group")
                        .WithMany("Tables")
            ...
            modelBuilder.Entity("Forms.Core.GridGroup", b =>
                {
                    b.HasOne("Forms.Core.GridGroup", "Parent")
                        .WithMany("Children")
