...
namespace Grids.Migrations.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AzView = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GridGroups", x => new { x.ProjectId, x.Id });
                    table.ForeignKey(
                        name: "FK_GridGroups_GridGroups_ProjectId_ParentId",
                        columns: x => new { x.ProjectId, x.ParentId },
                        principalSchema: "tmp",
                        principalTable: "GridGroups",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grids_GridGroups_ProjectId_GroupId",
            ...
            migrationBuilder.InsertData(
                schema: "tmp",
                table: "GridGroups",
                columns: new[] { "Id", "ProjectId", "AzView", "ParentId", "Title" },
                values: new object[] { 1, "project1", null, null, "System Tables" });

            migrationBuilder.InsertData(
                schema: "tmp",
                table: "Grids",
                columns: new[] { "Id", "ProjectId", "AzDelete", "AzInsert", "AzSelect", "AzUpdate", "AzView", "CreatedAt", "CreatedBy", "DefaultFilter", "DeleteSql", "Description", "Filterable", "GroupId", "HasFilterVariant", "InsertSql", "ModifiedAt", "ModifiedBy", "SelectSql", "TableName", "Title", "UpdateSql" },
                values: new object[,]
                {
                    { "tmp.Projects", "project1", null, null, null, null, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(2989), "", null, null, null, true, 1, false, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(2989), "", null, "tmp.Projects", "Projects", null },
                    { "tmp.AzObjects", "project1", null, null, null, null, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4668), "", null, null, null, true, 1, false, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4668), "", null, "tmp.AzObjects", "AzObjects", null },
                    { "tmp.AzObjectFields", "project1", null, null, null, null, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, null, null, true, 1, false, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, "tmp.AzObjectFields", "AzObjectFields", null },
                    { "tmp.AzFields", "project1", null, null, null, null, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, null, null, true, 1, false, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, "tmp.AzFields", "AzFields", null },
                    { "tmp.Applications", "project1", null, null, null, null, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, null, null, true, 1, false, null, new DateTime(2021, 11, 19, 21, 19, 47, 728, DateTimeKind.Utc).AddTicks(4676), "", null, "tmp.Applications", "Applications", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GridGroups_ProjectId_ParentId",
                schema: "tmp",
                table: "GridGroups",
